...
//Bootstrap 
  $bs = array(
   '#tag' => 'link', 
   '#attributes' => array(
     'href' => "https://cdn.rawgit.com/twbs/bootstrap/v4-dev/dist/js/bootstrap.min.js", 
    ),
  );
 drupal_add_html_head($bs, 'bs');

//Tether for Bootstrap
  $tt = array(
   '#tag' => 'link', 
   '#attributes' => array(
     'href' => "//cdnjs.cloudflare.com/ajax/libs/tether/1.3.1/js/tether.min.js", 
    ),
  );
 drupal_add_html_head($tt, 'tt');
 ...
 drupal_add_html_head($jUi, 'jUi');

  $ui = array(
   '#tag' => 'link', 
   '#attributes' => array(
     'href' => "https://code.jquery.com/ui/1.12.0/jquery-ui.js", 
    ),
  );
 drupal_add_html_head($ui, 'ui');
 ...
 drupal_add_html_head($font, 'font');
  ...
  drupal_add_css(drupal_get_path('theme', 'zen') . '/zen-internals/css/inlab-style.css', array('group' => CSS_THEME, 'type' => 'file'));

  drupal_add_js(drupal_get_path('theme', 'zen') . '/js/index.js', array(
  'type' => 'file',
  'group' => JS_THEME,
  ));
