    ...
    <div class="row">
      <div class="col-xs-12">
        <ul class="list-inline u-mb u-color-turquesa u-fs-xsmall u-uppercase">
          ...
          <li class="items-separator--arrow">
            <a href="#" class="link">
              <span class="u-color-gris"><?php print t('Prepara tu viaje')?></span>
            </a>
          </li>
        </ul>
      </div>
      ...
      <div class="col-xs-12 col-md-8 col-lg-9">
        <div class="page-content-container u-mb++ ">
          <div class="u-mb u-fs-h2 u-bold"><?php print t('Prepara tu viaje')?></div>
          <?php print $content ?>
        </div>
      </div>
      <?php } 
      else { ?>
      <a href="/es/admin/structure/block/manage/block/33/configure" class="btn btn--edit"><i style="margin-right: 5px;" class="fa fa-plus" aria-hidden="true"></i>Editar</a>
