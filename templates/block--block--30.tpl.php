    ...
    <div class="col-xs-12 col-md-4 col-lg-3">
      ...
      <div class="u-mb+++">
        ...
        <ul class="u-color-turquesa u-fs-small u-semibold">
          <li>
            <a href="/sites/all/themes/zen/Nexos/assets/images/prepara-viaje" class="link text-with-icon__content">
          ...
          <li class="horizontal-line-separator-top">
            <a href="/sites/all/themes/zen/Nexos/assets/images/info-paises" class="link text-with-icon__content">
          ...
          <li class="horizontal-line-separator-top horizontal-line-separator-bottom">
            <a href="/sites/all/themes/zen/Nexos/assets/images/preguntas-frecuentes" class="link text-with-icon__content">
