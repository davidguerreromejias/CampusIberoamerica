  ...
  <div class="overlay-page__container">
    ...
    <div class="overlay-page__content js-overlay-page-content">
      ...
      <ul class="list-inline">
        <li>
          <a href="https://twitter.com/Segibdigital" target="_blank" class="btn">
        ...
        <li>
          <a href="https://www.facebook.com/SEGIB/" target="_blank" class="btn">
        ...
        <li>
          <a href="https://es.pinterest.com/segibdigital/" target="_blank" class="btn">
  ...
  <div class="site-content-wrapper site-content-wrapper--centered">
    ...
    <div class="site-content-wrapper site-content-wrapper--centered">
      <ul class="list-inline u-mb+">
        <li>
          <button class="btn p-home_btn js-busqueda-home js-open-overlay btn-responsive" data-tipo="pregrado" data-target="#busquedaOverlay"><?php print t('Pregrado')?></button>
        </li>
        <li>
          <button class="btn p-home_btn js-busqueda-home js-open-overlay btn-responsive" data-tipo="postgrado" data-target="#busquedaOverlay"><?php print t('Postgrado')?></button>
        </li>
        <li>
          <button class="btn p-home_btn js-busqueda-home js-open-overlay btn-responsive" data-tipo="investigacion" data-target="#busquedaOverlay"><?php print t('Investigación / docencia')?></button>
        </li>
      </ul>
